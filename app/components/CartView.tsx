...
export default function CartView() {
  ...
  return (
    <div className="h-dvh bg-gradient-to-br from-[#0a8b9b] to-[#153f43] flex flex-col overflow-hidden">
      {/* Scrollable area - todo menos la barra inferior */}
      <div
      ...
      >
        ...
        <div className="px-4 md:px-6 lg:px-8 w-full">
          ...
          {/* Cart Items */}
          <div className="bg-white rounded-t-4xl px-6 md:px-8 lg:px-10 relative z-10">
            ...
            {cartState.items.length === 0 ? (
              ...
              <div>
                ...
                <div className="text-black mt-6 md:mt-8 pb-12">
      ...
      {/* Bottom section - fuera del scroll */}
      {cartState.items.length > 0 && (
        <div className="flex-shrink-0 bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] px-6 md:px-8 lg:px-10 mx-4 md:mx-6 lg:mx-8">
          <div className="w-full flex gap-3 md:gap-4 lg:gap-5 py-4 md:py-5 lg:py-6 justify-between">
